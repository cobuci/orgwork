...
public class RegisterAdmActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtUsername = findViewById(R.id.txtUsernameAdm);
        txtPassword =  findViewById(R.id.txtPasswordAdm);
        txtEmail =  findViewById(R.id.txtEmailAdm);

        view = findViewById(R.id.btnRegisterAdm);
    ...
    public void cadastro(){
        ...
        if(username.isEmpty() || password.isEmpty() || email.isEmpty()){
            ...
            final ProgressButton progressButton = new ProgressButton(RegisterAdmActivity.this, view);
            ...
            auth.createUserWithEmailAndPassword(
                    ...
                    .addOnCompleteListener(RegisterAdmActivity.this, new OnCompleteListener<AuthResult>() {
                        @Override
    ...
    protected void onStart() {
        ...
        ProgressButton progressButton = new ProgressButton(RegisterAdmActivity.this, view);
        progressButton.buttonRegister();
    }
